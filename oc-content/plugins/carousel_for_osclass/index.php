...
// future improvment add option to only show items with x amount of views. also debug feature.
    ...
    function carouselosclass_call_after_install() {
        ...
        // for example you might want to create a table or modify some values
         ...
         /* 1.5 preferences */
         osc_set_preference('carousel_items'        , '2', 'plugin-carousel_for_osclass', 'INTEGER');
	     ...
	     osc_set_preference('carousel_width'        , '398','plugin-carousel_for_osclass','INTEGER');
	     osc_set_preference('carousel_height'       , '215','plugin-carousel_for_osclass','INTEGER');
	     osc_set_preference('carousel_Swidth'       , '182','plugin-carousel_for_osclass','INTEGER');
	     osc_set_preference('carousel_Sheight'      , '166','plugin-carousel_for_osclass','INTEGER');
	     osc_set_preference('carousel_b_color'      , '#E9F5F9','plugin-carousel_for_osclass','STRING');
	     osc_set_preference('carousel_i_color'      , '#F78D4F','plugin-carousel_for_osclass','STRING');
